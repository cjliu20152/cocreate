...
The following steps enumerate how to use CoCreate:Lite.


### <a name="entering_aws_keys"></a>Entering your AWS Credentials.

You will need to provide your AWS credentials, so that CoCreate:Lite can manage the lifecycles of your applications.  

...
#
# A shell script that install depends needed to build virtualbox guest additions
#


yum -y install epel-release
yum -y install gcc make kernel-devel kernel-headers perl bzip2 dkms policycoreutils-python
